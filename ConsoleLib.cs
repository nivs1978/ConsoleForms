...
using static ConsoleForms.NativeMethods;
...
namespace ConsoleForms
{
    public static class ConsoleListener
    {
        ...
        public static event Action<ConsoleResizeEventArgs>? ConsoleResizeEvent;

        private static int lastWidth;
        private static int lastHeight;
        private static readonly Timer resizeTimer;
        ...
        static ConsoleListener()
        {
            ...
            resizeTimer = new Timer(CheckForResize, null, 0, 1000);
        }
        ...
        private static void CheckForResize(object state)
        {
            ...
            if (currentWidth != lastWidth || currentHeight != lastHeight)
            {
                ...
                ConsoleResizeEvent?.Invoke(new ConsoleResizeEventArgs(currentWidth, currentHeight));
            }
        }
